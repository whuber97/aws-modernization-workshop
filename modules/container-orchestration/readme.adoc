...
===== Deploy our VPC and ECR Repositories
We will first deploy our CloudFormation template which configures our ECS VPC and our ECR Repositories

1. Switch to the tab where you have your Cloud9 environment opened and change to this modules directory by running:
+
[source,shell]
----
cd ~/environment/aws-modernization-workshop/modules/container-orchestration
----
+
2. Deploy the CloudFormation template
[source,shell]
----
aws cloudformation create-stack --stack-name "petstore" --template-body file://petstore-fargate-cf-resources.yaml --capabilities CAPABILITY_NAMED_IAM
----
+
